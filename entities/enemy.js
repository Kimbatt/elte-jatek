...
class Enemy extends fw.Entity
{
    ...
    draw()
    {
        ...
        ctx.drawImage(currentSpriteSheet,
                    ...
                    (bodyPosition.x * PTM + offsetX - fw.cameraPositionX) | 0, (bodyPosition.y * PTM - fw.cameraPositionY) | 0,
                    currentAnimationData.width, currentAnimationData.height);
    }
...
(() =>
{
    ...
    [
        ...
        planck.Vec2(bodyWidth / PTM + offsetX - 6 / PTM, 256 / PTM),
        planck.Vec2(bodyWidth / PTM + offsetX, 250 / PTM),
        planck.Vec2(bodyWidth / PTM + offsetX, (256 - bodyHeight) / PTM),
    ];
